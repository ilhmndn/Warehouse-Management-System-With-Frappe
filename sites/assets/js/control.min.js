(function () {
	...
	// ignored /home/ilhmndn/frappe-training/apps/frappe/frappe/public/js/frappe/form/controls/quill-mention/quill.mention.css
	...
	frappe.ui.form.ControlGeolocation = frappe.ui.form.ControlCode.extend({
		make_wrapper: function make_wrapper() {
			...
			if ($input_wrapper.is(':visible')) {
				...
				$(document).on('quick-entry-dialog-open', function () {
					this$1.make_map();
				});
			}
		},
