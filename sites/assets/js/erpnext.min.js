		...
		**/
		...
		get_tree_options: function(option) {
			...
			if(user_permission && user_permission[unscrub_option]) {
				return user_permission[unscrub_option].map(function (perm) { return perm.doc; });
			} else {
	...
	*/
	...
	erpnext.TransactionController = erpnext.taxes_and_totals.extend({
		...
		scan_barcode: function() {
			...
			var show_description = function(idx, item_code, exist) {
			...
			if(this.frm.doc.scan_barcode) {
				frappe.call({
					...
					if(r && r.message && r.message.item_code) {
						...
						this$1.frm.doc.items.map(function (d) {
						...
						if(add_row_index == -1) {
							child = frappe.model.add_child(this$1.frm.doc, cur_grid.doctype, "items", add_row_index);
						} else {
						...
						scan_barcode_field.set_new_description(this$1.frm.doc.scan_barcode +__(' does not exist!'));
					}
				});
	...
	agriculture.TernaryPlot = class TernaryPlot {
		...
		make_plot() {
			...
			for (var soil_type in this$1.coords) {
				this$1.paper.polygon(this$1.get_coords(soil_type)).attr({
					fill: this$1.get_color(soil_type),
					stroke: this$1.config.stroke,
					strokeWidth: this$1.config.strokeWidth
				});
			}
		}
		...
		make_legend() {
			...
			for (var soil_type in this$1.coords) {
				...
				var rect = this$1.paper.rect(0+offset, 0+index*20, 100, 19, 5, 5).attr({
					fill: this$1.get_color(soil_type),
					stroke: frappe.ui.color.get('black')
				});
				var text = this$1.paper.text(5+offset, 16+index*20, soil_type).attr({
					fill: frappe.ui.color.get('black'),
					'font-size': 12
				});
				index++;
